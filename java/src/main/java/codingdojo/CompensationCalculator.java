...
public class CompensationCalculator {
  ...
  public static Overtime calculateOvertime(BigDecimal hoursOvertimeTotal, Assignment assignment, Briefing briefing) {
    ...
    if (checkOvertime(assignment, briefing, isWatcodeUnion, isWatcodeNonUnionForeign)) {
  ...
  private static boolean checkOvertime(Assignment assignment, Briefing briefing, boolean isWatcodeUnion, boolean isWatcodeNonUnionForeign) {
